...
exports.formatDomain = exports.mapWindows = exports.applySorting = exports.applyGrouping = exports.fetchState = exports.getGroupColor = exports.GROUP_COLORS = exports.ICONS = exports.sendMessage = void 0;
...
const getGroupColor = (name) => exports.GROUP_COLORS[name] || "#cbd5e1";
exports.getGroupColor = getGroupColor;
const fetchState = async () => {
    try {
        const response = await (0, exports.sendMessage)("getState");
        if (response.ok && response.data) {
            return response;
        }
        console.warn("fetchState failed, using fallback:", response.error);
        return await (0, localState_js_1.fetchLocalState)();
    }
    catch (e) {
