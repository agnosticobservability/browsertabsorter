...
exports.GENERA_REGISTRY = void 0;
exports.getGenera = getGenera;
exports.GENERA_REGISTRY = {
    // Search
    'google.com': 'Search',
    'bing.com': 'Search',
...
function getGenera(hostname, customRegistry) {
    ...
    // 1. Exact match
    if (exports.GENERA_REGISTRY[hostname]) {
        return exports.GENERA_REGISTRY[hostname];
    }
    ...
    for (let i = 0; i < parts.length - 1; i++) {
        const domain = parts.slice(i).join('.');
        if (exports.GENERA_REGISTRY[domain]) {
            return exports.GENERA_REGISTRY[domain];
        }
    }
    return null;
}
