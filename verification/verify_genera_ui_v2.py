...
def verify_custom_genera(page):
    ...
    # Scroll into view to ensure it's in the screenshot
    page.evaluate("document.getElementById('custom-genera-container').scrollIntoView()")

    # Wait a bit for the mock data to populate the list and scroll to finish
    page.wait_for_timeout(1000)

    # Take a screenshot
    page.screenshot(path='verification/custom_genera_ui_v2.png')
    print("Screenshot saved to verification/custom_genera_ui_v2.png")
